...
if (document.querySelectorAll('.header').length > 0) {
  document.addEventListener("DOMContentLoaded", () => {
    const widthScreen = window.matchMedia("(max-width: 1023.98px)");
...
if (document.querySelectorAll('.header').length > 0) {
  ...
  const searchBtnOpen = document.querySelector('.search__submit');
  const searchInput = document.querySelector('.search__input');
  document.addEventListener('click', e => {
    if (e.target == searchBtnOpen) {
...
if (document.querySelectorAll('.hero').length > 0) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.slider-hero', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_4__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_4__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_4__.EffectCube],
    speed: 600,
    loop: true,
    effect: "cube",
    //grabCursor: true,
...
if (document.querySelectorAll('.best').length > 0) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.best__slider', {
